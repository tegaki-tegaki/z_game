...
@export_range(9e-99, 9e99, 0.0000001, "hide_slider", "suffix:cm3") var volume_cm3: float
## used in inventory & damage calculations. kilograms
@export_range(9e-99, 9e99, 0.0000001, "hide_slider", "suffix:kg") var mass_kg: float
...
var texture_on_person: AtlasTexture 
